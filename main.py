...
if __name__ == '__main__':
    ...
    fillInCircle = True
    filledInArray = [[-0.6,0,0,0,0,0],[-0.5,-0.332,0,0,0,0],[-0.5,0.332,0,0,0,0],[-0.4,-0.447,0,0,0,0],[-0.4,0.447,0,0,0,0],[-0.3,-0.520,0,0,0,0],[-0.3,0.520,0,0,0,0],[-0.2,0.566,0,0,0,0],[-0.2,-0.566,0,0,0,0],[-0.1,0.592,0,0,0,0],[-0.1,-0.592,0,0,0,0],[0,-0.6,0,0,0,0],[0,0.6,0,0,0,0],[0.1,-0.592,0,0,0,0],[0.1,0.592,0,0,0,0],[0.2,-0.566,0,0,0,0],[0.2,0.566,0,0,0,0],[0.3,0.520,0,0,0,0],[0.3,-0.520,0,0,0,0],[0.4,-0.477,0,0,0,0],[0.4,0.477,0,0,0,0],[0.5,0.332,0,0,0,0],[0.5,-0.332,0,0,0,0],[0.6,0,0,0,0,0]]
